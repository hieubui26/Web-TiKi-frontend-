...
const AdminProduct = () => {
  ...
  const handleDetailsProduct = () => {
    // if (rowSelected) {
    //   setIsPendingUpdate(true);
    //   // setIsLoadingProduct(true); // Bắt đầu hiển thị loading
    //   // fetchGetDetailsProduct(rowSelected).finally(() =>
    //   //   setIsLoadingProduct(false)
    //   // ); // Dừng hiển thị loading khi hoàn thành
    // }
  ...
  const queryProduct = useQuery({
    queryKey: ["products"], // key của query
    queryFn: getAllProducts, // hàm dùng để lấy dữ liệu
  });
  ...
  return (
    <div>
      ...
      <DrawerComponent
        ...
        width="90%"
      >
        <Loading isLoading={isLoadingProduct || isPending || isPendingUpdated}>
          <Form
            name="basic"
            labelCol={{
              span: 2,
